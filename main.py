...
def drawNextShape(shape, surface):
    ...
    for i, line in enumerate(format):
        ...
        for j, column in enumerate(row):
            if column == '0':
                pygame.draw.rect(surface, shape.color, (sx + j*TAILLE_BLOC, sy + i*TAILLE_BLOC, TAILLE_BLOC, TAILLE_BLOC), 0)
...
def drawMainMenu(win):
    ...
    while run:
        win.fill((0,0,0))
        drawTextMiddle(win, 'Appuyez sur une touche pour jouer!', 48, (255,255,255))
...
def main(window):
    ...
    # TODO: Assigner à la variable meilleurDernierScore le meilleur dernier score obtenu
    # meilleurDernierScore = 

    # TODO Assigner à la variable descrPieceCourante une piece aleatoire
    # descrPieceCourante = 

    # TODO Assigner à la variable descrProchainePiece une piece aleatoire
    # descrProchainePiece = 
    ...
    while run:
        ...
        # TODO: Au début de la boucle, replir la variable grille avec les positionsConfirmees
        # grille = 
        ...
        if doitGenererNouvellePiece:
            ...
            # TODO: Appeller la fonction enleverLignesPleines avec la grille et les positionsConfirmées afin de mettre
            # à jour le score et les positionsConfirmees
            # points, positionsConfirmees = 
        ...
        #TODO: Assigner a la variable partiePerdue le resultat du predicat estPartiePerdue
        # partiePerdue = 

        if partiePerdue:
            # TODO: Sauvegarder le nouveau score contenu dans la variable score
            

            # POUR L'AFFICHAGE: On dit à l'utilisateur qu'il a perdu
            drawTextMiddle(window, "PARTIE PERDUE!", 80, (255,255,255))
            pygame.display.update()
